using Npgsql; //PostgreSQL veritabanı ile bağlantı kurmak ve sorgular göndermek için kullanılan kütüphanedir.
using System;
...
namespace Hastane
{
    public partial class Form2 : Form
    {
        ...
        NpgsqlConnection baglanti = new NpgsqlConnection("server=localHost; port=5432; Database=HastaneOtomasyonu; userID=postgres; password=798106");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("böyle bir hasta zaten bulunuyor.");
                }
